...
# Config
option_list = list(
  make_option(c("-f", "--file"), type="character", default='treated.json', 
              help="dataset file name [default: %default]", metavar="FILE"),
  make_option(c("-o", "--out"), type="character", default="treated.csv", 
