...
option_list = list(
  ...
  make_option(c("-s","--sales"), type="character", default="sales.json", help="path where to save the extracted sales", metavar="FILE"),
  make_option(c("-r","--redirects"), type="character", default="redis.json", help="path where to save the extracted redirects", metavar="FILE"),
  make_option(c("-t","--time"), type="double", default = 6, help="collection time duration in hours", metavar = "HOURS")
);
