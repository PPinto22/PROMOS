...
///////////////////////////////////////////////////////////////////
    ...
    class_<Parameters>("Parameters", init<>())
            ...
            .def_readwrite("ActivationFunction_Relu_Prob", &Parameters::ActivationFunction_Relu_Prob)
            .def_readwrite("ActivationFunction_Softplus_Prob", &Parameters::ActivationFunction_Softplus_Prob)
            ...
            .def_readwrite("CompatThreshChangeInterval_Generations", &Parameters::CompatThreshChangeInterval_Generations)
            .def_readwrite("CompatThreshChangeInterval_Evaluations", &Parameters::CompatThreshChangeInterval_Evaluations)
